# SGM832 电源监控与钱箱驱动移植（[项目代号] A16）

> **模块**: Charger | **厂商**: SG Micro | **芯片**: SGM832
> **平台**: QCM6490-A16 | **类型**: 需求
> **Change**: #196751 | **作者**: [同事] | **状态**: MERGED
...
| 提交标题 | `[[项目代号]_A16][121287/121288/121289]bring up sgm832 and lisbon cash[owner][同事]` |
| 任务 | Task 121287 / 121288 / 121289 |

## 需求描述

[项目代号] A16（MC9392 机型）需要 bring up 三个驱动：
...
> ⚠️ 项目 `meigla/kernel/qcom` 不在 134 服务器上（[项目代号] 仓库未同步），无法在 134 执行 `git apply --check`。已通过 Gerrit REST 拉取 current revision 源码与补丁逐一比对。
