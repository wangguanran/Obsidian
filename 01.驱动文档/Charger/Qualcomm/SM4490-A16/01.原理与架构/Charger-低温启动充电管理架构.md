...
- [项目代号] 产品要求：-15°C（热敏电阻 846.6kΩ）时样机必须能开机，因此 SBL 阶段先写 0x1090=0x00 关 JEITA，BattMan 运行阶段也强制 JEITA 全关

## 平台差异

- `pm_peripheral_chgr.c` 的 JEITA 接口在 `#if defined(ODM_PROJECT_[项目代号])` 分支下直接 `PM_OUT` 清 0x1090，而非按位掩码
