...
struct smb_charger {
	...
	int			die_health;
	/*pogo pin*/
	int pogo6pin_detect_id;
	int pogo6pin_detect_id_irq;
	bool last_pogo6pin_isinsert;
	int pogo6pin_remove_count;
	int pogo6pin_dcin_det;
	int pogo6pin_dcin_det_irq;
	int pogo6pin_5v_out ;
	int pogo8pin_fb_int;
	int pogo8pin_fb_int_irq;
	struct input_dev *input_dev;
	bool last_pogo8pin_isinsert;
	int pogo8pin_remove_count;
	int pogo8pin_5v_out;
	int ovp_usb_en;
	struct iio_channel	*pogo_device_adc_chan;
	bool battery_miss;
