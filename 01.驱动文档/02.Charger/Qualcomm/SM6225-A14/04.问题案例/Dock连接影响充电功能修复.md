...
| 文件 | 改动 | 说明 |
|------|------|------|
| [[01.驱动文档/02.Charger/Qualcomm/SM6225-A14/91.源码与补丁索引/kernel_driver/smb5-lib.c|smb5-lib.c]] | +26/-4 | 新增 `smblib_pogo_notify_usb_host_role()`；Dock 插入/拔出改为仅 extcon 通知；插入时补 EN2 使能 |
...
已归档到 [[01.驱动文档/02.Charger/Qualcomm/SM6225-A14/91.源码与补丁索引/|91.源码与补丁索引/]]：
...
| 序号 | 文件 | 完整路径（源码树内） | 说明 |
|:---|:---|:---|:---|
| 1 | [[01.驱动文档/02.Charger/Qualcomm/SM6225-A14/91.源码与补丁索引/kernel_driver/smb5-lib.c|smb5-lib.c]] | `kernel_platform/msm-kernel/drivers/power/supply/qcom/smb5-lib.c` | Dock host 仅 extcon 通知、不开 OTG_EN（+26/-4） |
