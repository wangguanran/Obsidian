...
- 提交: Revert "[MC936_Linux][TaskID]113211[Description]pcie-usb qcom patch[Solution]do it.[owner]qianyiping"
...
- 7998575 [119387][Rigel_Ubuntu][LCD]Fix issue that dp can not bringup
- cc0e3a2 [MC936_Linux][TaskID]113211 pcie-usb qcom patch（被回退对象）
- 4837dfd [Rigel_Ubuntu][TaskID]117628 add odm_rw sysfs nodes for SN and MAC
- ee09c25 [92106][Rigel_Ubuntu][LCD]Fix issue that MC937 cannot bring up edp panel when resume
