...
Copyright 2013-2017 by Qualcomm Technologies, Inc.  All Rights Reserved.
============================================================================*/
/*===========================================================================
...
bl_error_boot_type boot_uart_get_interface(boot_uart_if_type *uart_if)
{
	...
	do
	{
		if(uart_if == NULL)
		{
			return_status = GET_ERROR_CODE(BL_ERROR_GROUP_UART, BL_ERR_INVALID_PARAMETER);
			break;
		}
	
		uart_if->init = boot_uart_init;
		uart_if->rx = uart_read;
		uart_if->tx = boot_uart_tx;
