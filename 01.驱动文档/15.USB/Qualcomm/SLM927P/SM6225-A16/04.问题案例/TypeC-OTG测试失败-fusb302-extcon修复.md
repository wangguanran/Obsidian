...
| 提交标题 | `[SLM927P_A16][BugID]95891[Description] typec otg test failed[Solution]add fusb302 extcon [Owner]zhangjinwei` |
| BugID | 95891 |

## 现象

SLM927P_A16 项目 **TypeC OTG 测试失败**：Type-C 口无法在 host/device 之间正确切换，插入 OTG 设备（U 盘/键鼠）时 USB 不枚举，OTG 功能不可用。
...
| 文件 | 改动 | 说明 |
|------|------|------|
| [[01.驱动文档/15.USB/Qualcomm/SLM927P/SM6225-A16/91.源码与补丁索引/dt_config/khaje-idp.dtsi|khaje-idp.dtsi]] | +27/-0 | 新增 fusb302 节点（I2C 0x22、INT GPIO36）；usb0 挂 extcon=fusb302、usb-role-switch、otg-vbus-gpio |
| [[01.驱动文档/15.USB/Qualcomm/SLM927P/SM6225-A16/91.源码与补丁索引/dt_config/khaje-idp-nopmi.dtsi|khaje-idp-nopmi.dtsi]] | +7/-2 | 恢复 usb0 extcon；dr_mode peripheral→otg；otg-vbus-gpio |
| [[01.驱动文档/15.USB/Qualcomm/SLM927P/SM6225-A16/91.源码与补丁索引/dt_config/khaje-usb.dtsi|khaje-usb.dtsi]] | +2/-0 | usb0 增加 `extcon = <&eud>` |
...
通过补齐 FUSB302 Type-C 控制器节点、将 usb0 extcon 指向 fusb302、使能 usb-role-switch 并把 dr_mode 改为 otg，修复 SLM927P_A16 TypeC OTG 测试失败问题。补丁可在由 REST API 重建的父提交文件内容上干净应用。

## 补丁内容

```diff
Subject: [PATCH] [SLM927P_A16][BugID]95891[Description] typec otg test failed[Solution]add fusb302 extcon [Owner]zhangjinwei
...
已归档到 [[01.驱动文档/15.USB/Qualcomm/SLM927P/SM6225-A16/91.源码与补丁索引/|91.源码与补丁索引/]]：
...
| 序号 | 文件 | 完整路径（源码树内） | 说明 |
|:---|:---|:---|:---|
| 1 | [[01.驱动文档/15.USB/Qualcomm/SLM927P/SM6225-A16/91.源码与补丁索引/dt_config/khaje-idp.dtsi|khaje-idp.dtsi]] | `kernel_platform/qcom/proprietary/devicetree/qcom/khaje-idp.dtsi` | fusb302 节点 + usb0 extcon/role-switch（+27/-0） |
| 2 | [[01.驱动文档/15.USB/Qualcomm/SLM927P/SM6225-A16/91.源码与补丁索引/dt_config/khaje-idp-nopmi.dtsi|khaje-idp-nopmi.dtsi]] | `kernel_platform/qcom/proprietary/devicetree/qcom/khaje-idp-nopmi.dtsi` | usb0 恢复 extcon、otg、role-switch（+7/-2） |
| 3 | [[01.驱动文档/15.USB/Qualcomm/SLM927P/SM6225-A16/91.源码与补丁索引/dt_config/khaje-usb.dtsi|khaje-usb.dtsi]] | `kernel_platform/qcom/proprietary/devicetree/qcom/khaje-usb.dtsi` | usb0 补 eud extcon（+2/-0） |
