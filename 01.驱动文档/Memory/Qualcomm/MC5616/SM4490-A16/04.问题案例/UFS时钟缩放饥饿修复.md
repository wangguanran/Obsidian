...
- 平台：SM4490-A16（LA.VENDOR.1.0.R1，MC5616 分支）
...
| # | 文件 | 改动 | 说明 |
|---|------|------|------|
| 1 | [[01.驱动文档/Memory/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/kernel_driver/drivers/scsi/ufs/ufs-qcom.c\|ufs-qcom.c]] | +15/-1 | 降频阈值 UFS 2.x 放宽 + HOSINGLOBAL quirk 注册 |
| 2 | [[01.驱动文档/Memory/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/kernel_driver/drivers/scsi/ufs/ufs_quirks.h\|ufs_quirks.h]] | +1 | 定义 UFS_VENDOR_HOSINGLOBAL 0x0CD6 |
...
```diff
Subject: [PATCH] [MC5616][96242][UFS]Fix clock scaling starvation on high-latency HOSINGLOBAL UFS 2.x device
...
| 文件 | 路径 | 说明 |
|------|------|------|
| [[01.驱动文档/Memory/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/kernel_driver/drivers/scsi/ufs/ufs-qcom.c\|ufs-qcom.c]] | `kernel_platform/msm-kernel/drivers/scsi/ufs/ufs-qcom.c` | 时钟缩放参数 + quirk 注册 |
| [[01.驱动文档/Memory/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/kernel_driver/drivers/scsi/ufs/ufs_quirks.h\|ufs_quirks.h]] | `kernel_platform/msm-kernel/drivers/scsi/ufs/ufs_quirks.h` | UFS_VENDOR_HOSINGLOBAL 定义 |
| [[01.驱动文档/Memory/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/patches/197041.patch\|197041.patch]] | `patches/197041.patch` | 本变更补丁 |
