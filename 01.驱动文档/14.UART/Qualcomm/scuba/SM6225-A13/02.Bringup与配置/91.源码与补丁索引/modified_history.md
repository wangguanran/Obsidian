...
> **模块**: 14.UART | **厂商**: Qualcomm | **芯片**: scuba (SM6225)
> **平台**: SM6225-A13 (LA.VENDOR.13.2.1) | **分支**: MT5205
...
| 提交 | 描述 | 作者 |
|------|------|------|
| `1a96e40e9f50` | [MT5205][TaskID]118750/118744 config gpio69/70 gpio16/17 as uart (前置依赖) | zhaonannan |
