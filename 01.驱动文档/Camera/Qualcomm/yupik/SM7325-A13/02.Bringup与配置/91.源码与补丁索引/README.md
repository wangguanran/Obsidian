...
```
/home3/[同事]/workspace/[项目代号]/LA.VENDOR.1.0.R1/
```

> 说明：patch 路径为 `vendor/qcom/proprietary/devicetree/qcom/Makefile`，134 树上该 git 仓库 checkout 位于 `kernel_platform/qcom/...`，归档时按 patch 相对路径存放。[项目代号] 为当前 134 上可用的 sm7325 树，文件为 gpiotest 移除后状态。
