...
static int32_t GC9307_init(struct panel_spec *self)
{
	...
	GC9307_SpiWriteData(0x20);
	GC9307_SpiWriteCmd(0xc4);	
	GC9307_SpiWriteData(0x10);
	GC9307_SpiWriteCmd(0xc9);	
	GC9307_SpiWriteData(0x35);

	GC9307_SpiWriteCmd(0xF0);
	GC9307_SpiWriteData(0x1A);
	GC9307_SpiWriteData(0x1D);
	GC9307_SpiWriteData(0x0A);
	GC9307_SpiWriteData(0x08);
	GC9307_SpiWriteData(0xF5);
	GC9307_SpiWriteData(0x39);

	GC9307_SpiWriteCmd(0xF1);
	GC9307_SpiWriteData(0x4C);
	GC9307_SpiWriteData(0x9E);
	GC9307_SpiWriteData(0x5E);
	GC9307_SpiWriteData(0x29);
	GC9307_SpiWriteData(0x2F);
	GC9307_SpiWriteData(0xAf);
