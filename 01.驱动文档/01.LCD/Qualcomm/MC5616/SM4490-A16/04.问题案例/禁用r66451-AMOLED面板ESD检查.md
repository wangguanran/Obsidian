...
| 文件 | 改动 | 说明 |
|------|------|------|
| [[01.驱动文档/01.LCD/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/dt_config/parrot-sde-display-common.dtsi|parrot-sde-display-common.dtsi]] | +1/−1 | `&dsi_r66451_amoled_video` 节点中注释 `qcom,esd-check-enabled` |
...
- [[01.驱动文档/01.LCD/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/dt_config/parrot-sde-display-common.dtsi|parrot-sde-display-common.dtsi]] — `vendor/qcom/proprietary/display-devicetree/display/parrot-sde-display-common.dtsi`，SDE 显示通用配置（含 r66451 AMOLED 面板节点）
- [[01.驱动文档/01.LCD/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/patches/196185.patch|196185.patch]] — Change #196185 完整补丁
- [[01.驱动文档/01.LCD/Qualcomm/MC5616/SM4490-A16/91.源码与补丁索引/modified_history.md|modified_history.md]] — 本平台修改历史
