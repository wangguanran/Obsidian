...
## Change #196371 (AP 侧)
- 提交: [MT5205][TaskID]118727[Description]fix JD9365DA init data for display error in AP[Owner]lixianghui
...
- 提交: [MT5205][TaskID]118727[Description]fix JD9365DA UEFI init data for display error in BP[Owner]lixianghui
...
- 提交: [MT5205][TaskID]118727[Description] fix unused PmicGpioProtocol breaking other UEFI builds[Owner]lixianghui
...
## Change #196443 (需求)
- 提交: [MT5205][TaskID]120699[Description]Increase the display PWM frequency[Owner]lixianghui
