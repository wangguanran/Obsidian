...
[项目代号] 平台使用 r66451 AMOLED video 面板，开机及使用过程中出现**屏闪烁/显示异常**。排查为面板 ESD 检测误触发所致：
...
- 项目：LA.VENDOR.1.0.R1（[项目代号]，Snapdragon Premium High 2021）
...
| 文件 | 改动 | 说明 |
|------|------|------|
| [[01.驱动文档/LCD/Qualcomm/SM4490-A16/91.源码与补丁索引/dt_config/parrot-sde-display-common.dtsi\|parrot-sde-display-common.dtsi]] | +1/−1 | `&dsi_r66451_amoled_video` 节点中注释 `qcom,esd-check-enabled` |
...
r66451 AMOLED video 面板的 ESD 检查在 [项目代号] 平台误触发，导致驱动周期性执行 panel recovery 造成屏闪。通过在 DTS 节点中注释 `qcom,esd-check-enabled` 禁用该面板 ESD 检测（保留 status 属性便于复开），问题闭环。改动为单行配置，风险低、可回退。
...
- [[01.驱动文档/LCD/Qualcomm/SM4490-A16/91.源码与补丁索引/dt_config/parrot-sde-display-common.dtsi|parrot-sde-display-common.dtsi]] — `vendor/qcom/proprietary/display-devicetree/display/parrot-sde-display-common.dtsi`，SDE 显示通用配置（含 r66451 AMOLED 面板节点）
- [[01.驱动文档/LCD/Qualcomm/SM4490-A16/91.源码与补丁索引/patches/196185.patch|196185.patch]] — Change #196185 完整补丁
- [[01.驱动文档/LCD/Qualcomm/SM4490-A16/91.源码与补丁索引/modified_history.md|modified_history.md]] — 本平台修改历史
