# Qualcomm SM6225 (SLM927P/divar) ADSP SSC Sensor POR 机制分析

> **版本号：v1.0**

## 平台概述

SLM927P（divar/SM6225）的传感器由 ADSP SSC 管理。SSC 在 ADSP 侧通过 **POR（Power-On Reset Sequence）配置**控制各传感器的上电时序：
...
- [[01.驱动文档/Sensor/Qualcomm/SLM927P/SM6225-A16/04.问题案例/SensorPOR配置修复.md|SensorPOR配置修复]]（补丁内容）
