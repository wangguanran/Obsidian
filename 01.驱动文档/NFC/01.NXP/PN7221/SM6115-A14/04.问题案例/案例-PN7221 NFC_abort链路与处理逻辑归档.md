...
2. HAL扩展解析到非白名单reason，走异常恢复入口：
   - `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/hardware/nxp/nfc/pn72xx/halimpl/hal/phNxpNciHal_ext.cc:523`
   - `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/hardware/nxp/nfc/pn72xx/halimpl/hal/phNxpNciHal_ext.cc:555`
3. `phNxpNciHal_emergency_recovery(0xA7)` 在当前版本走 default，仅记录 invalid status：
   - `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/hardware/nxp/nfc/pn72xx/halimpl/utils/phNxpNciHal_utils.cc:493`
4. NCI stack 对 `CORE_RESET_NTF` 只把 `0x01/0x02` 视为正常，其余走错误恢复并触发 `nfc_ncif_cmd_timeout()`：
   - `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/system/nfc/src/nfc/nfc/nfc_ncif.cc:1668`
   - `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/system/nfc/src/nfc/nfc/nfc_ncif.cc:1684`
...
- `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/packages/apps/Nfc/src/com/android/nfc/NfcService.java:2231`
- `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/packages/apps/Nfc/nci/jni/NativeNfcManager.cpp:1783`

#### 3.2 HAL service 侧 abort 链路（nfc_pn72xx@1.2-service）
1. 恢复/关闭阶段出现连续 I2C 失败（`ret(-107)`），`write_unlocked` 重试耗尽：
   - `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/hardware/nxp/nfc/pn72xx/halimpl/hal/phNxpNciHal.cc:1328`
   - `workspace/[项目代号]_A14/LA.VENDOR.13.2.1.R2/hardware/nxp/nfc/pn72xx/halimpl/hal/phNxpNciHal.cc:1342`
